<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			...
			<div class="content-header-title">Level User Form</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<div class="content-box">
					<form id="form-action">
						...
						<div class="form-group">
							...
							<input class="form-control" name="group_nama" placeholder="Level User" type="text">
							<div class="validation-message" data-field="group_nama"></div>
						</div>
					</form>
