<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			...
			<div class="content-header-title">Status Form</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<div class="content-box">
					<form id="form-action">
						<input type="text" name="id_status" class="hidden">
						<div class="form-group">
							<label for="">Nama Status </label>
							<input class="form-control" name="status" placeholder="Status Name" type="text">
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
	        url: "<?php echo base_url() . 'status/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'status/action'; ?>", formData).done(function(data) {
