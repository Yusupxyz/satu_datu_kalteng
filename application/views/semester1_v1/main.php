...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'semester1_v1/data'; ?>",
		...
		{field: 'ket', title: 'Keterangan Invalid', sortable: false, width: 400, align: 'center', search: false, 
		rowStyler: function(rowData, rowIndex) {
	...
	function download(rowIndex) {
		window.location.href = "<?php echo base_url() . 'semester1_v1/download/'; ?>" + rowIndex;
	}
