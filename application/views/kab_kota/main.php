	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Kabupaten/Kota</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Kabupaten/Kota</button>
								</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'kab_kota/data'; ?>",
		primaryField			: 'id_kabupaten_kota', 
		rowNumber				: true,
		...
		columns					: [
		{field: 'kabupaten_kota', title: 'Kabupaten/Kota', editable: true, sortable: false, width: 450, align: 'left', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'kab_kota/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'kab_kota/delete'; ?>", {id : row.id_kabupaten_kota}).done(function(data) {
				datagrid.reload();
			});
		});
	}
