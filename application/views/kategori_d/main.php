	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Kategori Direktorat</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Kategori Direktorat</button>
								</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'kategori_d/data'; ?>",
		primaryField			: 'id_kategori_direktorat', 
		rowNumber				: true,
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'kategori_d/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'kategori_d/delete'; ?>", {id : row.id_kategori_direktorat}).done(function(data) {
				datagrid.reload();
			});
		});
	}
