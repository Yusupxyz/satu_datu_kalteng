				...
				<div class="content-box">
					<form id="form-action" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<select name="kategori_d_id" class="form-control">
							...
							<div class="validation-message" data-field="kategori_d_id"></div>
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
			url: "<?php echo base_url() . 'semester2_u/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.ajax({
                     url:'<?php echo base_url() . 'semester2_u/create'; ?>', //URL submit
