...
class Semester2_v1 extends Base_Controller {
	...
	public function index()
	{
		...
		$this->data['subview'] = 'semester2_v1/main';
		$this->load->model('status_m');
		$this->data['status']=$this->status_m->all();
		$this->load->model('lembar_kerja_m');
		$this->data['status_aktif']=$this->lembar_kerja_m->get_lk_aktif("Semester 2");
	...
	public function form()
	{
		...
		$this->load->view('semester2_v1/form', $data);
	}
	...
	public function data()
	{
		...
		if($this->session->userdata('active_user')->group_id == '3'){
			...
			echo json_encode($this->lembar_kerja_m->getJson3($this->input->post(),'Semester 2'));
		}
	}
	...
	public function download($id=null){			
        ...
        force_download('assets/uploads_s2/'.$file->file_upload,NULL);
